...
func Load() (*Settings, error) {
	s := &Settings{
		...
		DefaultDetector:         getEnv("SPIDER_DEFAULT_DETECTOR", "rule-based"),
		...
		Chunker:                 getEnv("SPIDER_CHUNKER", "fixed"),
		ChunkSize:               getEnvInt("SPIDER_CHUNK_SIZE", 2048),
		ChunkOverlap:            getEnvInt("SPIDER_CHUNK_OVERLAP", 128),
		DefaultModel:            getEnv("SPIDER_DEFAULT_MODEL", "mock-llm"),
		ServingProvider:         getEnv("SPIDER_SERVING_PROVIDER", "mock"),
